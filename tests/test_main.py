...
from main import get_candidate_data_by_election_id, get_list_of_candidate_data
...
class TestGetListOfCandidates:
    ...
    def test_empty_dataframe_returns_empty_list(self):
        ...
        result = get_list_of_candidate_data(empty_df)
        assert result == []


class TestGetFullElectionJson:
    def test_returns_dict(self, sample_df):
        result = get_candidate_data_by_election_id(sample_df)
    ...
    def test_empty_dataframe_returns_empty_dict(self):
        empty_df = pd.DataFrame(columns=["person_name", "person_id", "party_name", "election_id"])
        result = get_candidate_data_by_election_id(empty_df)
        assert result == {}
